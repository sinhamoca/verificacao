// routes/public.js - COM SUPORTE COMPLETO GESOFFICE ✅
...
module.exports = (db) => {
    ...
    // ========================================
    // CRIAR PAGAMENTO (UNIFICADO) ✅ CORRIGIDO
    // ========================================
    router.post('/create-payment', async (req, res) => {
        try {
            ...
            // ✅ CORREÇÃO: Buscar username do revendedor (Sigma, Koffice OU GesOffice)
            let resellerInfo;
            ...
            // ✅ VALIDAÇÃO: Verificar se encontrou o revendedor
