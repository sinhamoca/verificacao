// services/MonitorService.js - COMPLETO COM RUSHPLAY
...
const RushPlayService = require('./RushPlayService'); // ⭐ NOVO
...
class MonitorService {
    ...
    async checkPendingPayments() {
        try {
            // ⭐ MULTI-TENANT: Query com RUSHPLAY incluído
    ...
    async processRecharge(payment, isRetry = false) {
        try {
            ...
            console.error(`[Monitor] ❌ Erro ao processar recarga do pagamento ${payment.id}:`, error.message);
