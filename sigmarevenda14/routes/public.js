// routes/public.js - COMPLETO COM RUSHPLAY + TODAS AS ROTAS
...
module.exports = (db) => {
    ...
    router.post('/create-payment', async (req, res) => {
        try {
            ...
            // ⭐ RUSHPLAY
                ...
                resellerInfo = await db.get(`
                    SELECT rr.*, rp.url, rp.admin_username, rp.admin_password, rp.tenant_id
                    FROM rushplay_resellers rr
                    JOIN rushplay_panels rp ON rr.panel_id = rp.id
                    WHERE rr.id = ?
                `, [resellerId]);
    ...
    // ========================================
    // VERIFICAR E PROCESSAR PAGAMENTO MANUALMENTE
    // ========================================
