...
const AdminNavigation = {
    ...
    initThemeToggle() {
        ...
        if (!themeToggle || !themeIcon) {
            console.warn('⚠️  [AdminNavigation] Botão de tema não encontrado');
            return;
        }

        // Carregar tema salvo
        const savedTheme = localStorage.getItem('adminTheme') || 'light';
        this.applyTheme(savedTheme, themeIcon);
        ...
        themeToggle.addEventListener('click', () => {
            ...
            console.log(`🎨 [AdminNavigation] Tema alterado: ${currentTheme} → ${newTheme}`);
        });

        console.log(`✓ [AdminNavigation] Theme toggle configurado (tema atual: ${savedTheme})`);
    },
