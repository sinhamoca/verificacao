// js/admin/auth.js - VERSÃO COMPLETA COM GESOFFICE CORRIGIDA
...
const AdminAuth = {
    ...
    async login() {
        ...
        try {
            ...
            if (tenant) {
                loginUrl += `?tenant=${tenant}`;
                console.log(`🔑 [Admin Login] Fazendo login com tenant: ${tenant}`);
            } else {
                console.log(`🔑 [Admin Login] Fazendo login sem tenant (default)`);
            }
            ...
            if (response.ok && data.success) {
                ...
                console.log(`✅ Login bem-sucedido: ${data.admin.username} (Tenant: ${data.admin.tenant_name})`);
...
// ✅ CORRIGIDO: CRIA VERSÕES AUTENTICADAS DAS FUNÇÕES GESOFFICE
// ========================================

if (typeof API !== 'undefined' && API.admin) {
    // 🔧 NÃO salvar as funções antigas - vamos criar versões autenticadas
    ...
    API.admin = {
        ...
        // ✅ Painéis GesOffice (UNIPLAY) - COM AUTENTICAÇÃO
        ...
        // ✅ Revendedores GesOffice (UNIPLAY) - COM AUTENTICAÇÃO
        ...
        // ⭐ Painéis DashboardBz (NOVO)
        async getDashboardBzPanels() {
            const response = await AdminAuth.fetchWithAuth('/api/admin/dashboardbz-panels');
            return response.json();
        },

        async createDashboardBzPanel(data) {
            const response = await AdminAuth.fetchWithAuth('/api/admin/dashboardbz-panels', {
                method: 'POST',
                body: JSON.stringify(data)
            });
        ...
        async updateDashboardBzPanel(id, data) {
            const response = await AdminAuth.fetchWithAuth(`/api/admin/dashboardbz-panels/${id}`, {
                method: 'PUT',
                body: JSON.stringify(data)
            });
            return response.json();
        ...
        async deleteDashboardBzPanel(id) {
            const response = await AdminAuth.fetchWithAuth(`/api/admin/dashboardbz-panels/${id}`, {
                method: 'DELETE'
            });
            return response.json();
        ...
        // ⭐ Revendedores DashboardBz (NOVO)
        async getDashboardBzResellers() {
            const response = await AdminAuth.fetchWithAuth('/api/admin/dashboardbz-resellers');
            return response.json();
        },

        async createDashboardBzReseller(data) {
            const response = await AdminAuth.fetchWithAuth('/api/admin/dashboardbz-resellers', {
                method: 'POST',
                body: JSON.stringify(data)
            });
        ...
        async updateDashboardBzReseller(id, data) {
            const response = await AdminAuth.fetchWithAuth(`/api/admin/dashboardbz-resellers/${id}`, {
                method: 'PUT',
                body: JSON.stringify(data)
            });
            return response.json();
        ...
        async deleteDashboardBzReseller(id) {
            const response = await AdminAuth.fetchWithAuth(`/api/admin/dashboardbz-resellers/${id}`, {
                method: 'DELETE'
            });
            return response.json();
