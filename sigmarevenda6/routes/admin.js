...
module.exports = (db) => {
    ...
    router.get('/stats', requireAuth, async (req, res) => {
        try {
            ...
            // Calcular totais
            stats.active_panels = (stats.active_sigma_panels || 0) + (stats.active_koffice_panels || 0);
            stats.active_resellers = (stats.active_sigma_resellers || 0) + (stats.active_koffice_resellers || 0);
