...
const API = {
    ...
    admin: {
        ...
        // Painéis DashboardBz
        getDashboardBzPanels: () => API.get('/api/admin/dashboardbz-panels'),
        createDashboardBzPanel: (data) => API.post('/api/admin/dashboardbz-panels', data),
        updateDashboardBzPanel: (id, data) => API.put(`/api/admin/dashboardbz-panels/${id}`, data),
        deleteDashboardBzPanel: (id) => API.delete(`/api/admin/dashboardbz-panels/${id}`),

        // Revendedores DashboardBz
        getDashboardBzResellers: () => API.get('/api/admin/dashboardbz-resellers'),
        createDashboardBzReseller: (data) => API.post('/api/admin/dashboardbz-resellers', data),
        updateDashboardBzReseller: (id, data) => API.put(`/api/admin/dashboardbz-resellers/${id}`, data),
        deleteDashboardBzReseller: (id) => API.delete(`/api/admin/dashboardbz-resellers/${id}`),
