// js/admin/packages.js - CORRIGIDO
...
const AdminPackages = {
    ...
    async loadPackages() {
        try {
            // CORREÇÃO: Adicionar type=sigma na query
            const packages = await API.admin.getPackages(this.currentResellerId, 'sigma');
