// js/shared/api.js - VERSÃO COMPLETA COM SIGMA + KOFFICE + GESOFFICE
const API = {
    baseUrl: '',
    ...
    public: {
        ...
        login: (username) => {
            const url = typeof TenantUtils !== 'undefined' ? 
                TenantUtils.getAPIURL('/api/public/login') : 
                '/api/public/login';
    ...
    admin: {
        ...
        // Painéis GesOffice (UNIPLAY) ✅ ADICIONADO
        ...
        // Revendedores GesOffice (UNIPLAY) ✅ ADICIONADO
        ...
        // Packages (unificado - funciona para sigma, koffice e gesoffice)
