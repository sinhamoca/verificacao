// services/MonitorService.js - COM SUPORTE MULTI-TENANT + SIGMA + KOFFICE + GESOFFICE
...
class MonitorService {
    ...
    async checkPendingPayments() {
        try {
            // ⭐ MULTI-TENANT: Query busca tenant_id junto com os pagamentos
    ...
    async retryPayment(paymentId) {
        try {
            // ⭐ MULTI-TENANT: Buscar pagamento com tenant_id
