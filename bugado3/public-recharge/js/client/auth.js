// js/client/auth.js - COMPLETO COM TODOS OS PAINÉIS + PAINELFODA
const ClientAuth = {
    ...
    async login() {
        ...
        try {
            ...
            // ✅ MOSTRAR TIPO DO PAINEL COM ÍCONE CORRETO (COM PAINELFODA)
            let panelTypeLabel;
            if (data.type === 'sigma') {
    ...
    checkSession() {
        ...
        if (sessionData) {
            try {
                ...
                // Ir para step 3 (seleção de pacotes)
                Utils.goToStep(3);
