// js/admin/payments.js - COM SUPORTE KOFFICE
...
const AdminPayments = {
    ...
    renderPayments(payments) {
        ...
        payments.forEach(payment => {
            ...
            // Badge do tipo
            const typeColor = payment.reseller_type === 'sigma' ? '#4caf50' : '#9c27b0';
            const typeLabel = payment.reseller_type === 'sigma' ? '🟢 Sigma' : '🟣 Koffice';
            const typeBadge = `<span class="badge" style="background: ${typeColor}20; color: ${typeColor};">${typeLabel}</span>`;
    ...
    renderTransactions(transactions) {
        ...
        transactions.forEach(tx => {
            ...
            // Badge do tipo
            const typeColor = tx.reseller_type === 'sigma' ? '#4caf50' : '#9c27b0';
            const typeLabel = tx.reseller_type === 'sigma' ? '🟢' : '🟣';
            const typeBadge = `<span class="badge" style="background: ${typeColor}20; color: ${typeColor};">${typeLabel}</span>`;
